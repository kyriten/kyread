...
<header class="header fixed-top d-flex align-items-center" id="header">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a class="logo d-flex align-items-center" href="/dashboard">
            <img src="pos/assets/img/brand.svg" alt="">
            <span class="navbar-brand d-none d-lg-block">kyreadSeller</span>
        </a>
        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img class="rounded-circle" src="pos/assets/img/messages-1.jpg" alt="">
                            <div>
                                <h4>Maria Hudson</h4>
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img class="rounded-circle" src="pos/assets/img/messages-2.jpg" alt="">
                            <div>
                                <h4>Anna Nelson</h4>
                                <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                <p>6 hrs. ago</p>
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img class="rounded-circle" src="pos/assets/img/messages-3.jpg" alt="">
                            <div>
                                <h4>David Muldon</h4>
                                <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                <p>8 hrs. ago</p>
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" data-bs-toggle="dropdown" href="#">
                    <img class="rounded-circle" src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Profile">
